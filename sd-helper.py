...
alert_badge = (
    "[![Alert](https://img.shields.io/badge/-Alert-orange.svg?"
    "style=flat-square&logo=gitter-white&logoWidth=8)]()"
)
success_badge = (
    "[![Success](https://img.shields.io/badge/-Success-brightgreen.svg?"
    "style=flat-square&logo=gitter-white&logoWidth=8)]()"
)
failed_badge = (
    "[![Failed](https://img.shields.io/badge/-Failed-red.svg?"
    "style=flat-square&logo=gitter-white&logoWidth=8)]()"
)
help_badge = (
    "[![Help](https://img.shields.io/badge/-Help-blue.svg?"
    "style=flat-square&logo=gitter-white&logoWidth=8)]()"
)
rem_badge = (
    "[![Reminder](https://img.shields.io/badge/-Reminder-lightgrey.svg?"
    "style=flat-square&logo=gitter-white&logoWidth=8)]()"
)
